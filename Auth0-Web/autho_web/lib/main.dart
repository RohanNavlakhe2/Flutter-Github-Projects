...
import 'auth_client/client_interface.dart';
...
const String AUTH0_REDIRECT_URI = 'http://localhost:60664/callback.html';
...
void main() async {
  //B2CAuth b2cAuth = B2CAuth();
  B2CAuthWeb authWeb = B2CAuthWeb();
  await authWeb.processStartup();
  //await B2CAuth().processStartup();
  runApp(MyApp(authWeb: authWeb,));
}

class MyApp extends StatefulWidget {
  B2CAuthWeb authWeb;
  MyApp({Key key,this.authWeb}) : super(key: key);
...
class _MyAppState extends State<MyApp> {
        ...
        body: Center(
          child: isBusy
              ...
              : isLoggedIn
                  ...
                  : Login(loginWebAction, errorMessage), //loginAction
        ),
      ),
    );
  }
  ...
  Future<void> loginWebAction() async{
    widget.authWeb.signIn();
  }
