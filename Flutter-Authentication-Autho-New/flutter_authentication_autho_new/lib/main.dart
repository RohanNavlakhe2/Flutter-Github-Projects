...
const String AUTH0_DOMAIN = 'dev-fwhugmus.us.auth0.com';
const String AUTH0_CLIENT_ID = 'K4aQGIftoSvf1OZVasx9emMjkFF5DCwa';

const String AUTH0_REDIRECT_URI = 'demo://dev-fwhugmus.us.auth0.com/android/com.picstar.picstarapp/callback';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> loginAction() async {
    ...
    try {
      ...
      print('Login Result : ${result.idToken}');
